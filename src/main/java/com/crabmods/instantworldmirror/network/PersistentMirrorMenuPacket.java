...
public record PersistentMirrorMenuPacket(
    ...
    public static final Type<PersistentMirrorMenuPacket> TYPE = new Type<>(
            ResourceLocation.fromNamespaceAndPath(InstantWorldMirror.MODID, "persistent_mirror_menu")
    );

    public static final StreamCodec<FriendlyByteBuf, PersistentMirrorMenuPacket> STREAM_CODEC = StreamCodec.of(
    ...
    private static void encode(FriendlyByteBuf buf, PersistentMirrorMenuPacket packet) {
    ...
    private static PersistentMirrorMenuPacket decode(FriendlyByteBuf buf) {
    ...
    public static void handle(PersistentMirrorMenuPacket packet, IPayloadContext context) {
        context.enqueueWork(() -> PersistentMirrorMenuScreen.open(packet));
    }
