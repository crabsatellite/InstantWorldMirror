...
public record MirrorKindSettings(
    ...
    public static final int MIN_COPY_CHUNK_RADIUS = 1;
    public static final int MAX_COPY_CHUNK_RADIUS = 32;
    ...
    public static int clampCopyChunkRadius(int value) {
        return Math.max(MIN_COPY_CHUNK_RADIUS, Math.min(MAX_COPY_CHUNK_RADIUS, value));
    }
}
