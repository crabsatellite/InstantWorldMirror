...
public class MirrorConfig {
    ...
    public static final ForgeConfigSpec.EnumValue<MirrorAccess> STRANDED_MIRROR_ACCESS = BUILDER
    ...
    public static final ForgeConfigSpec.BooleanValue STRANDED_MIRROR_MOB_SPAWNING = BUILDER
    ...
    public static final ForgeConfigSpec.BooleanValue STRANDED_MIRROR_ITEM_TRANSFER = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue STRANDED_MIRROR_COPY_CHUNK_RADIUS = BUILDER
            .comment("Capture radius in chunks for the Stranded Mirror (default: 10).",
                    "Total chunks captured = (radius*2+1)^2.",
                    "Note: Changes saved from the in-game config screen require a server restart to take effect.")
