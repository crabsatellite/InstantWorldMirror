...
| `temporary.stranded_mirror` | `interaction` | `covered` | `kind.stranded_present`, `item.stranded_capture_ui`, `network.stranded_packets`, `client.stranded_ui_gate`, `runtime.stranded_interaction_routes`, `runtime.stranded_packet_roundtrip` |
